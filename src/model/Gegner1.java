...
public class Gegner1 extends Entity {
	...
	public Gegner1(float x, float y, Handler handler, ObjectId id) {
		super(x, y, id);
		this.handler = handler;
		GegnerLives = 1;
		velX = 2 + Level;
		if (id != ObjectId.Block && handler != null) {
	...
	public void render(Graphics g) {
		...
		if (Alive == true) {
			Gegner1.drawAnimation(g, (int) x - 5, (int) y, 40, 40);
		}
		HitEnemy(g);
	}
