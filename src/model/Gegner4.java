...
public class Gegner4 extends Entity {
	...
	private Animation Gegner4;
	private Animation Gegner_tod;

	public Gegner4(float x, float y, Handler handler, ObjectId id) {
		super(x, y, id);
		this.handler = handler;
		GegnerLives = 1;
		velX = 2 + Level;
		Gegner4 = new Animation(6, tex.gegner[27], tex.gegner[28], tex.gegner[29], tex.gegner[30], tex.gegner[31],
	...
	public void render(Graphics g) {
		...
		if (Alive == true) {
			Gegner4.drawAnimation(g, (int) x - 5, (int) y, 40, 40);
		}
		HitEnemy(g);
	}
